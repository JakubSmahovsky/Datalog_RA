...
public class Rule {
     ...
     * If a relation is missing from the provided Instance, this function stops
     * and returns false (TODO(JakubSmahovsky): change this behaviour)
    ...
    /**
     * Updates the internal operator used to calculate the result.
     * Operator contains relations in positive and negative fact source.
     * Should be called after either of fact sources is updated.
     */
    ...
    /**
     * Calculates and returns the result of rule and returns it as a 
     * relation.
     */

...
public class Query {
    ...
    /** 
    * Function building sequence of instances until limits are found.
    * Each new instance is the result of gelfond-lifschitz-reduktion
    * from the preceding instance.
    */
    ...
    /** 
    * Function building a single gelfond-lifschitz-reduktion.
    * Program evaluation is repeated with fixed negative facts
    * untill a fixpoint is reached. 
    */
    ...
    /**
     * Creates an intersection of the limit instances.
     * The answer contains all tuples that are true in the well-founded model.
     */
